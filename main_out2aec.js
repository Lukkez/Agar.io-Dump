...
var _debug = (function(exports) {
	...
	var defaultSeriesStyle =  { strokeStyle: 'rgba(0, 255, 0, 1)', fillStyle: 'rgba(0, 255, 0, 0.2)', lineWidth: 2 };

	var createTimeseries = function()
	{
		var tseries = new TimeSeries({resetBounds: false});
		return tseries;
	}
	...
	var createOneChart = function(id, opts)
	{
		...
		createChart(id, [_series[id]], opts, [{ strokeStyle: 'rgba(0, 255, 0, 1)', fillStyle: 'rgba(0, 255, 0, 0.2)', lineWidth: 2 }]);
	}
	var createChart = function(id, series, chart_opts, series_opts){

		var canvasID = id + "Canvas";
		var chartDiv = $("<canvas>", {id: canvasID});
	...
	var init = function(){
		...
		createOneChart('networkUpdate', { name:"network updates", minValue: 0, maxValue: 240 });
		
		
		_series['rttSDev'] = createTimeseries();
		_series['rttMean'] = createTimeseries();
		createChart(	'rttMean', 
						[_series['rttSDev'], _series['rttMean']], 
						{ name:"rtt", minValue: 0, maxValue: 120 },
						[ 
							{ strokeStyle: 'rgba(255, 0, 0, 1)', fillStyle: 'rgba(0, 255, 0, 0.2)', lineWidth: 2 },
						 	{ strokeStyle: 'rgba(0, 255, 0, 1)', fillStyle: 'rgba(0, 255, 0, 0)', lineWidth: 2 }
						]);

		createOneChart('fps', { name:"fps", minValue: 0, maxValue: 70 });
...
var countries = {
	...
	'AX': 'EU-London',
	'AL': 'EU-London',
	'DZ': 'EU-London', /* Actually Africa */
	'AS': 'SG-Singapore',
	'AD': 'EU-London',
	'AO': 'EU-London', /* Actually Africa */
	'AI': 'US-Atlanta',
	'AG': 'US-Atlanta',
	'AR': 'BR-Brazil',
	'AM': 'JP-Tokyo',
	...
	'BE': 'EU-London',
	'BZ': 'US-Atlanta',
	'BJ': 'EU-London', /* Actually Africa */
	'BM': 'US-Atlanta',
	'BT': 'JP-Tokyo',
	'BO': 'BR-Brazil',
	'BQ': 'US-Atlanta',
	'BA': 'EU-London',
	'BW': 'EU-London', /* Actually Africa */
	'BR': 'BR-Brazil',
	'IO': 'JP-Tokyo',
	'VG': 'US-Atlanta',
	'BN': 'JP-Tokyo',
	'BG': 'EU-London',
	'BF': 'EU-London', /* Actually Africa */
	'BI': 'EU-London', /* Actually Africa */
	'KH': 'JP-Tokyo',
	'CM': 'EU-London', /* Actually Africa */
	'CA': 'US-Atlanta',
	'CV': 'EU-London', /* Actually Africa */
	'KY': 'US-Atlanta',
	'CF': 'EU-London', /* Actually Africa */
	'TD': 'EU-London', /* Actually Africa */
	'CL': 'BR-Brazil',
	'CN': 'CN-China',
	'CX': 'JP-Tokyo',
	'CC': 'JP-Tokyo',
	'CO': 'BR-Brazil',
	'KM': 'EU-London', /* Actually Africa */
	'CD': 'EU-London', /* Actually Africa */
	'CG': 'EU-London', /* Actually Africa */
	'CK': 'SG-Singapore',
	'CR': 'US-Atlanta',
	'CI': 'EU-London', /* Actually Africa */
	'HR': 'EU-London',
	'CU': 'US-Atlanta',
	'CW': 'US-Atlanta',
	'CY': 'JP-Tokyo',
	'CZ': 'EU-London',
	'DK': 'EU-London',
	'DJ': 'EU-London', /* Actually Africa */
	'DM': 'US-Atlanta',
	'DO': 'US-Atlanta',
	'EC': 'BR-Brazil',
	'EG': 'EU-London', /* Actually Africa */
	'SV': 'US-Atlanta',
	'GQ': 'EU-London', /* Actually Africa */
	'ER': 'EU-London', /* Actually Africa */
	'EE': 'EU-London',
	'ET': 'EU-London', /* Actually Africa */
	'FO': 'EU-London',
	'FK': 'BR-Brazil',
	'FJ': 'SG-Singapore',
	'FI': 'EU-London',
	...
	'GF': 'BR-Brazil',
	'PF': 'SG-Singapore',
	'GA': 'EU-London', /* Actually Africa */
	'GM': 'EU-London', /* Actually Africa */
	'GE': 'JP-Tokyo',
	'DE': 'EU-London',
	'GH': 'EU-London', /* Actually Africa */
	'GI': 'EU-London',
	'GR': 'EU-London',
	'GL': 'US-Atlanta',
	'GD': 'US-Atlanta',
	...
	'GT': 'US-Atlanta',
	'GG': 'EU-London',
	'GN': 'EU-London', /* Actually Africa */
	'GW': 'EU-London', /* Actually Africa */
	'GY': 'BR-Brazil',
	'HT': 'US-Atlanta',
	'VA': 'EU-London',
	'HN': 'US-Atlanta',
	...
	'LV': 'EU-London',
	'LB': 'JP-Tokyo',
	'LS': 'EU-London', /* Actually Africa */
	'LR': 'EU-London', /* Actually Africa */
	'LY': 'EU-London', /* Actually Africa */
	'LI': 'EU-London',
	'LT': 'EU-London',
	'LU': 'EU-London',
	'MO': 'JP-Tokyo',
	'MK': 'EU-London',
	'MG': 'EU-London', /* Actually Africa */
	'MW': 'EU-London', /* Actually Africa */
	'MY': 'JP-Tokyo',
	'MV': 'JP-Tokyo',
	'ML': 'EU-London', /* Actually Africa */
	'MT': 'EU-London',
	'MH': 'SG-Singapore',
	'MQ': 'US-Atlanta',
	'MR': 'EU-London', /* Actually Africa */
	'MU': 'EU-London', /* Actually Africa */
	'YT': 'EU-London', /* Actually Africa */
	'MX': 'US-Atlanta',
	'FM': 'SG-Singapore',
	'MD': 'EU-London',
	'MC': 'EU-London',
	...
	'ME': 'EU-London',
	'MS': 'US-Atlanta',
	'MA': 'EU-London', /* Actually Africa */
	'MZ': 'EU-London', /* Actually Africa */
	'MM': 'JP-Tokyo',
	'NA': 'EU-London', /* Actually Africa */
	'NR': 'SG-Singapore',
	'NP': 'JP-Tokyo',
	'NL': 'EU-London',
	'NC': 'SG-Singapore',
	'NZ': 'SG-Singapore',
	'NI': 'US-Atlanta',
	'NE': 'EU-London', /* Actually Africa */
	'NG': 'EU-London', /* Actually Africa */
	'NU': 'SG-Singapore',
	'NF': 'SG-Singapore',
	'MP': 'SG-Singapore',
	'NO': 'EU-London',
	...
	'PR': 'US-Atlanta',
	'QA': 'JP-Tokyo',
	'RE': 'EU-London', /* Actually Africa */
	'RO': 'EU-London',
	'RU': 'RU-Russia',
	'RW': 'EU-London', /* Actually Africa */
	'BL': 'US-Atlanta',
	'SH': 'EU-London', /* Actually Africa */
	'KN': 'US-Atlanta',
	'LC': 'US-Atlanta',
	'MF': 'US-Atlanta',
	'PM': 'US-Atlanta',
	...
	'WS': 'SG-Singapore',
	'SM': 'EU-London',
	'ST': 'EU-London', /* Actually Africa */
	'SA': 'EU-London',
	'SN': 'EU-London', /* Actually Africa */
	'RS': 'EU-London',
	'SC': 'EU-London', /* Actually Africa */
	'SL': 'EU-London', /* Actually Africa */
	'SG': 'JP-Tokyo',
	'SX': 'US-Atlanta',
	'SK': 'EU-London',
	'SI': 'EU-London',
	'SB': 'SG-Singapore',
	'SO': 'EU-London', /* Actually Africa */
	'ZA': 'EU-London', /* Actually Africa */
	'SS': 'EU-London', /* Actually Africa */
	'ES': 'EU-London',
	'LK': 'JP-Tokyo',
	'SD': 'EU-London', /* Actually Africa */
	'SR': 'BR-Brazil',
	'SJ': 'EU-London',
	'SZ': 'EU-London', /* Actually Africa */
	'SE': 'EU-London',
	'CH': 'EU-London',
	'SY': 'EU-London',
	'TW': 'JP-Tokyo',
	'TJ': 'JP-Tokyo',
	'TZ': 'EU-London', /* Actually Africa */
	'TH': 'JP-Tokyo',
	'TL': 'JP-Tokyo',
	'TG': 'EU-London', /* Actually Africa */
	'TK': 'SG-Singapore',
	'TO': 'SG-Singapore',
	'TT': 'US-Atlanta',
	'TN': 'EU-London', /* Actually Africa */
	'TR': 'TK-Turkey',
	'TM': 'JP-Tokyo',
	'TC': 'US-Atlanta',
	'TV': 'SG-Singapore',
	'UG': 'EU-London', /* Actually Africa */
	'UA': 'EU-London',
	'AE': 'EU-London',
	'GB': 'EU-London',
	'US': 'US-Atlanta',
	...
	'VN': 'JP-Tokyo',
	'WF': 'SG-Singapore',
	'EH': 'EU-London', /* Actually Africa */
	'YE': 'JP-Tokyo',
	'ZM': 'EU-London', /* Actually Africa */
