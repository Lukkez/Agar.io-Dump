...
i18n_dict = {
  "en": {
    ...
    "rush_details_placedesc_a": "1st Place", 
    "rush_details_placedesc_b": "Top 5", 
    "rush_details_placedesc_c": "Top 10", 
    "rush_details_placedesc_d": "Finish", 
    "rush_mode_unlock_fee": "Fee: %rush_fee%", 
...
function i18n(s){
	return window['i18n'][s] || window['i18n_dict']['en'][s] || s;
}
